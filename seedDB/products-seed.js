...
async function seedDB() {
  ...
  //--------------------coldPressedJuices
  const coldPressedJuices_titles = [
    "cold1",
    "cold2",
  ];
  ...
  await seedProducts(coldPressedJuices_titles, coldPressedJuices_imgs, "Cold Pressed Juices");
