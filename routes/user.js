...
router.post("/emailVerification", middleware.isNotLoggedIn, async (req, res) => {
  try {
    ...
    transporter.sendMail(mailOptions, (error, info) => {
      ...
      req.flash("success", "A verification email has been sent. Please check your inbox.");
...
router.get("/verify", async (req, res) => {
  try {
    ...
    console.error(error);
    req.flash("error", "An error occurred while processing the verification request.");
    res.redirect("/");
  }
});
